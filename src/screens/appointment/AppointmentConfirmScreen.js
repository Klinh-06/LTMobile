    ...
    <SafeAreaView edges={['top']} style={styles.safe}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          <Row icon="person-outline" label="Họ tên" value={user?.fullName || 'John Doe'} />
          <Row icon="call-outline" label="Điện thoại" value={user?.phone || ''} />
        ...
        <View style={styles.card}>
          ...
          {[
            ...
            { step: '3', floor: 'Tầng 2', room: `Phòng khám ${doctor.specialty}`, desc: 'Vào phòng khi được gọi số, mang theo CCCD để bác sĩ đối chiếu' },
        ...
        <View style={styles.noteBox}>
          ...
          <View style={{ flex: 1, marginLeft: 10 }}>
            ...
            <Text style={styles.noteText}>Vui lòng mang theo <Text style={{ fontWeight: '700' }}>CCCD/CMND bản gốc</Text> để đối chiếu thông tin tại quầy lễ tân và phòng khám.</Text>
          </View>
        </View>
